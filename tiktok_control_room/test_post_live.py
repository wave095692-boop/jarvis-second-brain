...
with sync_playwright() as p:
    print("Launching Chromium Chrome channel (Headed for live post test)...")
    context = p.chromium.launch_persistent_context(
        user_data_dir=user_data_dir,
        headless=True,  # Run headless for scripting but we will take screenshots
        channel="chrome",
    ...
    if file_input.is_visible() or True:
